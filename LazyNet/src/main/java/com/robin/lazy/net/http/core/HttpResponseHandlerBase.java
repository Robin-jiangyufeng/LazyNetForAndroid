...
public interface HttpResponseHandlerBase {
     ...
     * @see [类、类#方法、类#成员]
     */
    int sendRequest(HttpURLConnection urlConnection, RequestParam request);
     ...
     * @see [类、类#方法、类#成员]
     */
    boolean readResponse(HttpURLConnection urlConnection, int responseCode, RequestParam request);
