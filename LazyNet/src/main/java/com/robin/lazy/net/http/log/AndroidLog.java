package com.robin.lazy.net.http.log;
...
public class AndroidLog implements ILog {
     ...
     * @param throwable
     */
    private void log(int logLevel,@NonNull String tag,@NonNull String message,
     ...
     * @param throwable
     */
    private void print(int logLevel, @NonNull String tag,@NonNull String message,
                       @Nullable Throwable throwable) {
        switch (logLevel) {
            case VERBOSE:
                if(throwable==null){
